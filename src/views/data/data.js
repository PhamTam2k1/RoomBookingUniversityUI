export const moviesData = [{
  ...
  export const floors  = [
    { Name: 'Tầng 1 - tòa A1', ID: 0, BuildingID: 0 },
    { Name: 'Tầng 2 - tòa A1', ID: 1, BuildingID: 0 },
    { Name: 'Tầng 1 - tòa A2', ID: 2, BuildingID: 1 },
    { Name: 'Tầng 2 - tòa A2', ID: 3, BuildingID: 1 },
    { Name: 'Tầng 1 - tòa A3', ID: 4, BuildingID: 2 },
    { Name: 'Tầng 1 - tòa B1', ID: 5, BuildingID: 3 },
    { Name: 'Tầng 2 - tòa B1', ID: 6, BuildingID: 3 },
    { Name: 'Tầng 1 - tòa B2', ID: 5, BuildingID: 4 },
    { Name: 'Tầng 1 - tòa C1', ID: 5, BuildingID: 5 },
    { Name: 'Tầng 1 - tòa C2', ID: 5, BuildingID: 6 },
    
  ];

  export const rooms = [
    { Name: 'Phòng P01 - Tầng 1 - tòa A1', ID: 0, FloorID: 0,BuildingID: 0 },
    { Name: 'Phòng P02 - Tầng 1 - tòa A1', ID: 1, FloorID: 0,BuildingID: 0 },
    { Name: 'Phòng P03 - Tầng 1 - tòa A1', ID: 2, FloorID: 0,BuildingID: 0 },

    { Name: 'Phòng P04 - Tầng 2 - tòa A1', ID: 3, FloorID: 1,BuildingID: 0 },
    { Name: 'Phòng P05 - Tầng 2 - tòa A1', ID: 4, FloorID: 1,BuildingID: 0 },
    { Name: 'Phòng P06 - Tầng 2 - tòa A1', ID: 5, FloorID: 1,BuildingID: 0 },

    { Name: 'Phòng P07 - Tầng 1 - tòa A2', ID: 3, FloorID: 2,BuildingID: 1 },
    { Name: 'Phòng P08 - Tầng 1 - tòa A2', ID: 4, FloorID: 2,BuildingID: 1 },
    { Name: 'Phòng P09 - Tầng 1 - tòa A2', ID: 5, FloorID: 2,BuildingID: 1 },
